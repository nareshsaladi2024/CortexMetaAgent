# PowerShell script to deploy ReasoningCostAgent using Application Default Credentials (ADC)
# Uses your user account credentials (from gcloud auth)
# Run this script from the ReasoningCostAgent directory

$agentName = "ReasoningCostAgent"
...
# Deploy using ADK
# ADK automatically uses agent.name from agent.py (should be "ReasoningCostAgent")
